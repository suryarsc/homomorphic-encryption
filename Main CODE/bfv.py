...
class MyBfv:
    ...
    def bfv_menu(self):
        while True:
            menu_choice = int(input('''\033[1mCurrent Algothim: BFV\033[0m
\033[1m1. Show Current Numbers Being Used\033[0m
   ╵---> \033[3mSee Number1 and Number2 which are user entered integers which will be used for operations\033[0m
...
\033[1m3. Perform Operations\033[0m
   ╵---> \033[3mPerform addition, substraction, and multiplication on encrypted integers\033[0m
...
\033[1m5. Exit\033[0m\n\nYour Choice: '''))
    ...
    def process_choice(self, menu_choice):
        if menu_choice == 1:
            ...
            print(
                f"\033[1mCurrent Integers Being Used:\033[0m {self.HE.decrypt(self.number1)[0]}, {self.HE.decrypt(self.number2)[0]}\n")
